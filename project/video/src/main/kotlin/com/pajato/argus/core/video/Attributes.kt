...
sealed class Attribute {
    ...
    abstract fun persist(updateKey: String, videoId: Long, persister: Persister)
}
...
class Cast(val performers: MutableList<String> = mutableListOf()) : Attribute() {
    ...
    override fun persist(updateKey: String, videoId: Long, persister: Persister) {
...
fun getLong(arg: String): Long = try {
    arg.toLong()
